...
import DashboardNewUsers from '../../mainPages/DashBoardNewUsers';
import NewUsersServiceCard from '../NewUsers/NewUsersServiceCard';
...
const  MainTabs = () => {
  return (
    ...
    >
      <Tab.Screen name="Home" component={DashboardNewUsers} 
      options={{
        headerShown:false,
        tabBarIcon:({focused})=>(
